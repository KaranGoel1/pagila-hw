...
$$
SELECT film.title FROM film INNER JOIN film_category ON film_category.film_id = film.film_id INNER JOIN category ON category.category_id = film_category.category_id WHERE category.name = $1  ORDER BY film.title ASC;
$$
LANGUAGE SQL
IMMUTABLE
